...
I ett agilt arbetssätt arbetar teamet istället med korta iterationer där enskilda funktioner och ändringar presenteras oftare för användarna.
...
Vi kan föreställa oss att projekt A gäller ett lagersystem som ska migrera orderdata enligt fasta, dokumenterade regler och kraven förväntas inte förändras. Här är vattenfallsmodellen ett bra och effektivt alternativ eftersom tydliga krav gör planering, dokumentation och ordningsföljd mer förutsägbara.
